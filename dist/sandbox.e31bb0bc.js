...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{posts: $krisajenkins$remotedata$RemoteData$NotAsked},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $krisajenkins$remotedata$RemoteData$Loading = {$: 'Loading'};
var $author$project$Main$GotPostsResponse = function (a) {
	return {$: 'GotPostsResponse', a: a};
};
...
var $author$project$Main$postsDecoder = $elm$json$Json$Decode$list(
	A4(
		$elm$json$Json$Decode$map3,
...
var $author$project$Main$fetchPosts = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$GotPostsResponse),
			$author$project$Main$postsDecoder),
		url: 'https://jsonplaceholder.typicode.com/posts'
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'GotPostsResponse') {
			var data = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
			...
			return _Utils_Tuple2(
				...
				$author$project$Main$fetchPosts);
		}
	});
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Main$GetPosts = {$: 'GetPosts'};
var $elm$html$Html$article = _VirtualDom_node('article');
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $author$project$Main$blogArticle = function (post) {
	return A2(
...
var $author$project$Main$errorToString = function (httpError) {
	switch (httpError.$) {
		case 'BadUrl':
			var string = httpError.a;
			return 'Bad URL: ' + string;
		case 'Timeout':
			return 'It took too long to get a response';
		case 'NetworkError':
			return 'NetworkError';
		case 'BadStatus':
...
var $author$project$Main$postView = function (postData) {
	switch (postData.$) {
		case 'NotAsked':
			return A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Not asked for posts yet')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$GetPosts)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Fetch Posts')
							]))
					]));
		case 'Loading':
		...
		default:
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					function (post) {
						return $author$project$Main$blogArticle(post);
					},
					postList));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Lorem Ipsum blog')
					])),
				$author$project$Main$postView(model.posts)
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Post":{"args":[],"type":"{ id : Basics.Int, title : String.String, body : String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"GotPostsResponse":["RemoteData.RemoteData Http.Error (List.List Main.Post)"],"GetPosts":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Loading":[],"Failure":["e"],"Success":["a"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
